 ...
 var _testing = false;
 var loader_gif = '<img src="/gifs/loader.gif" style="width: 50px; height: 50px;">';
 ...
 for(var row = 0; row < total_examples; row ++){
     ...
     var conversionTypeTd = "<td><select class='conversionTypeSelector' id='conversionTypeSelect_" + row + "'><option value='adapt'>Predictive</option><option value='mimic'>Guided</option></select></td>";
     ...
     recording_table_html += "<td class='recordingControls' ><button id='stopButton_" + row + "'>Stop</button></td><td class='recordingControls' id ='recordingholder_" + row + "' ></td>" + sourceFileSelectTd + selectedSourceFileTd + speakerSelectTd  + conversionTypeTd + fileSelectTd + selectedFileTd + convertedAudioTd + "</tr>";
 ...
 function upload(){
     ...
     for(var rn = 0; rn < total_examples; rn++){
         ...
         var conversion_type_key = "conversion_type_" + rn;
         var speaker_val = $("#speakerSelect_" + rn).val();
         var conversion_type = $("#conversionTypeSelect_" + rn).val();
         ...
         fd.append(conversion_type_key, conversion_type);
